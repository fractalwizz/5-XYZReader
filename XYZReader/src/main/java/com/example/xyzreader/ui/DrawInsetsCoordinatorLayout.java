...
public class DrawInsetsCoordinatorLayout extends CoordinatorLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DrawInsetsCoordinatorLayout, defStyle, 0);
        assert a != null;
    ...
    public void setInsetBackground(Drawable insetBackground) {
        ...
        if (insetBackground != null) { insetBackground.setCallback(this); }
    ...
    public void onAttachedToWindow() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) { requestApplyInsets(); }
        if (mInsetBackground != null) { mInsetBackground.setCallback(this); }
    }
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets insets) {
        ...
        if (mOnInsetsCallback != null) { mOnInsetsCallback.onInsetsChanged(mInsets); }
        return insets;
    }
