...
public class ItemsContract {
	...
	public static class Items implements ItemsColumns {
		...
		/** Matches: /items/ */
		public static Uri buildDirUri() { return BASE_URI.buildUpon().appendPath("items").build(); }
        ...
        public static long getItemId(Uri itemUri) { return Long.parseLong(itemUri.getPathSegments().get(1)); }
	}
